...
// crosses the `/skill-manager` boundary. It recognizes the four typed error
// surfaces — InstallError (#14), UpdateError (#16), SkillsShError (#12), and
// PathSafetyError (#11) — and folds everything else into `internal`.
