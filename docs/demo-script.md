...
| 7 | 2:15–2:30 | Scroll to **Managed skills**; the skill you just installed is listed with its source and install time. | "Managed skills lists only what this plugin installed." |
