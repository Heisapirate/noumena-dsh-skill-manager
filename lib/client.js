...
`;
		...
		function ManagedSkillRow({ skill, updateAction, uninstallAction, onUpdate, onUninstall }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(UpdateAction, {
						skill,
						action: updateAction,
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UninstallAction, {
						skill,
		...
		function UpdateAction({ skill, action, confirming, confirmation, onStart, onCancel, onConfirm }) {
			if (action.status === "pending") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				style: styles$2.disabledButton,
				disabled: true,
				"aria-busy": true,
				children: "Updating…"
			});
			if (confirming) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: styles$2.confirm,
				role: "group",
				"aria-label": `Confirm update ${skill.slug}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					style: styles$2.confirmText,
					children: confirmation.message
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: styles$2.confirmButtons,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						style: styles$2.button,
						onClick: onConfirm,
						children: confirmation.confirmLabel
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						style: styles$2.button,
						onClick: onCancel,
			...
			if (action.status === "success") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				role: "status",
				style: styles$2.success,
				children: ["✓ ", action.message]
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				style: skill.canUpdate ? styles$2.button : styles$2.disabledButton,
				disabled: !skill.canUpdate,
				onClick: onStart,
				"aria-label": `Update ${skill.slug}`,
				children: "Update"
			}), action.status === "error" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				style: styles$2.errorText,
				children: action.error?.message
			})] });
		}
		function UninstallAction({ skill, action, confirming, confirmation, onStart, onCancel, onConfirm }) {
			if (action.status === "pending") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				style: styles$2.disabledButton,
				disabled: true,
			...
			if (confirming) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: styles$2.confirm,
				role: "group",
				"aria-label": `Confirm uninstall ${skill.slug}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					style: styles$2.confirmText,
					children: confirmation.message
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		...
		function ResultRow({ row, managedSlugs, action, onInstall }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(InstallAction, {
						row,
						decision,
						action,
						confirming,
		...
		function InstallAction(props) {
			...
			if (action.status === "error") {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: retryOverwrite ? "Replace" : "Retry"
					})]
				});
			}
			if (confirming) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: styles$1.confirm,
				role: "group",
				"aria-label": `Confirm replace ${row.name}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					style: styles$1.confirmText,
					children: "Reinstalling replaces the installed version of this skill."
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
						gap: "6px"
			...
			if (decision.kind === "overwrite") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		function createActionStore(options) {
			...
			return {
				...
				runUninstall(id, optionsArg) {
					run("uninstall", id, () => options.uninstall(id, {
