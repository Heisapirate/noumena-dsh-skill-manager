...
`;
		...
		function ManagedSkillsSection({ state, onRefresh }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				...
				state.status === "error" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						...
						children: ["Could not load managed skills: ", state.error]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
				...
				state.status === "ready" && state.skills.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
					style: styles$2.list,
					role: "list",
					children: state.skills.map((skill) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ManagedSkillRow, { skill }, skill.slug))
				})
			] });
		}
		function ManagedSkillRow({ skill }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						style: styles$2.action,
						disabled: true,
						"aria-label": `Update ${skill.id}`,
						children: "Update"
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						style: styles$2.action,
